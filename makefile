...
INCLUDES = -I$(DOMAIN_DIR) -I$(REPO_DIR) -I$(DTO_DIR) -I$(SERVICE_DIR) -I$(UTILS_DIR) -I$(CLI_DIR) $(JSON_INCLUDE)
...
$(TARGET): $(MAIN_SRC) $(DOMAIN_SRCS) $(REPO_SRCS) $(DTO_SRCS) $(SERVICE_SRCS) $(UTILS_SRCS) $(CLI_SRCS) | $(BIN_DIR)
	$(CXX) $(CXXFLAGS) $(INCLUDES) $^ -o $@

test: $(TEST_TARGET)
	./$(TEST_TARGET)

$(TEST_TARGET): $(TEST_SRC) $(DOMAIN_SRCS) $(REPO_SRCS) $(DTO_SRCS) $(SERVICE_SRCS) $(UTILS_SRCS) $(CLI_SRCS) | $(BIN_DIR)
	$(CXX) $(CXXFLAGS) $(INCLUDES) $^ -o $@
